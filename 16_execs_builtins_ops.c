...
/**
  ...
  * @tokens: stdin token fetched
  * @bcase: make bultins caps
...
/**
 * check_access - checks if path exists
 * @comm: way to command
 * @token: command token
...
/**
 * prep_execve - prepares command by checking current path
 * @token: tonek received
 * Return: 0 if unsuccessful
 */
...
/**
  * exec_nb - exec function for non-builtins
  * @tokens: stdin tokens received
